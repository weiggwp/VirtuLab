    ...
    pagination(c, m) {
        ...
        for (let i of range) {
            if (l) {
                if (i - l === 2) {
                    rangeWithDots.push(
                        <Pagination.Item onClick={() => this.handlePageFrontend(l + 1)} id={l + 1} key={l + 1} active={l + 1 === active}>
                            {l + 1}
                        </Pagination.Item>);
                } else if (i - l !== 1) {
            ...
            rangeWithDots.push(
                <Pagination.Item onClick={() => this.handlePageFrontend(i)} id={i} key={i} active={i === active}>
                    {i}
                </Pagination.Item>);
            l = i;
        }
