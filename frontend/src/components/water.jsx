...
const SvgComponent =
    ...
    <svg
        ...
        <g opacity={0.4}>
            <ellipse cx={24} cy={42.5} rx={14} ry={4.5} fill={fill} />
            <g fill={fill}>
                <rect width="28" height="25" x="10" y="17" />
                {/*<path d="M10 17h28v25H10z" />*/}
                <ellipse cx={24} cy={17.2} rx={14} ry={2.5} fill={fill} />
                <ellipse cx={24} cy={17.2} rx={14} ry={2.5} fill={topfill} opacity={.6}  />
            </g>
        </g>
        <path
